...
### <span id="head15">安装滑动组件 vue-awesome-swiper</span>
...
#### <span id="head20">添加全局 Loading 动画</span>
...
### <span id="head24"> vant的tab标签页使用</span>
...
#### <span id="head30"> commentsComponent（父/对外组件）</span>
